...
import com.company.ZunameComparator;
...
public class MitarbeiterApp {
    public static void main(String[] args) {
        ...
        String[] strArr = {"Hansis Erste Hits", "Hansi Beste", "Hansis Neuestes Album"};
        ...
        ArrayList<Mitarbeiter> mrList = new ArrayList<Mitarbeiter>();
        ...
        Arrays.sort(mrArr); //error because we did not implement comparable
        System.out.println(Arrays.toString(mrArr));
